...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    pil = sprites.createProjectileFromSprite(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . 2 . . . . . . . . . . . . . . 
        . . 2 . . . . . . . . . . . . . 
...
function LVL_3 () {
    if (LVL == 2) {
        ...
        game.setDialogFrame(img`
            ...
            ccccc...................
            `)
        game.showLongText("Tak skat nu får du en tur i kanen ", DialogLayout.Bottom)
    }
}
function clear_LVL_1 () {
...
info.onScore(5, function () {
    if (LVL == 1) {
        ...
        clear_LVL_1()
        game.splash("Nu kommer forstærkningerne, de er hurtigere men det er du også")
        LVL_2()
    } else if (LVL == 2) {
        game.splash("Level 2 Complete! Prinsessen får stang")
        LVL_3()
    }
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    sprites.destroy(mySprite, effects.clouds, 500)
    info.changeLifeBy(-1)
...
scene.setBackgroundImage(img`
    ...
    `)
game.splash("Der var engang en jæger der boede med sin prinsesse på et smukt slot, de var lykkelige og havde det godt. Men en dag kom der et lille monster med en besked. Overgiv prinsessens krone til os eller vi kommer og tager den. Det kunne jægeren ikke gå med tiil og gjorde sig klar til kamp. ")
scene.setBackgroundImage(img`
...
controller.moveSprite(mySprite, controller.dy(), 100)
...
game.onUpdateInterval(700, function () {
    if (LVL == 1) {
        haj = sprites.create(img`
            ...
            ....................fffff........fff
            `, SpriteKind.Enemy)
        haj.x = scene.screenWidth()
        haj.vx = -20
        haj.y = randint(10, scene.screenHeight())
    } else if (LVL == 2) {
        haj = sprites.create(img`
            ...........fffffff...ccfff..........
            ..........fbbbbbbbffcbbbbf..........
